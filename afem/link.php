...
$outfile = fopen("afem.html","w");
fputs($outfile,$header);
fputs($outfile,'<h1>akArAnta feminine words (See <a href="https://github.com/sanskrit-lexicon/CORRECTIONS/issues/53">Issue 53</a>)</h1>');
$counter = 1;
...
fclose($outfile);
echo "Check afem.html for testing.\n";
?>
